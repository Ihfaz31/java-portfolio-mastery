...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("DEBUG: User is " + currentUser.getUsername() + " with role " + currentUser.role + ".");
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    inventory.bookResource(scanner.nextLine().toUpperCase());
                    break;
                case "3":
                    System.out.print("Enter ID to Release: ");
                    String releaseId = scanner.nextLine().toUpperCase();
                    // InventoryService.releaseResource expects only the resource ID
                    inventory.releaseResource(releaseId);
                    break;
                case "4":
                    running = false;
                ...
                case "5":
                    ...
                    String newId = scanner.nextLine().toUpperCase();
        ...
        break;
                default:
                    System.out.println("Invalid selection. Try 1-5.");
            }
        }
        scanner.close();
    }
